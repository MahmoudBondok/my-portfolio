...
const Project = ({ SidbarWidth }) => {
  const ProArray = [
    {
      ...
      Github: "https://github.com/AhmedSafwat97/E-Commerce-with-shopping-cart-using-React-redux",
    ...
    },
    {
      ...
      Title: "Movie App",
      Discription: "Movies App using React js ",
  ...
  return (
    ...
    <Box component="a" href={`${item.demo}`} >
                  <Button  size="small" color="primary">
                    Demo
                  </Button>
    </Box>
    <Box component="a" href={`${item.Github}`} >
                  <Button  size="small" color="primary">
                    Github
                  </Button>
    </Box>
